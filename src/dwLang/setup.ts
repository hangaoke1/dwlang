...
export function setupLanguage(surveyData): IDisposable {
    ...
    // token 分词配置
    disposables.push(languages.setMonarchTokensProvider(languageID, monarchLanguage));
    // 语言设置
    disposables.push(languages.setLanguageConfiguration(languageID, richLanguageConfiguration));
    ...
    // 代码悬停提示
    disposables.push(languages.registerHoverProvider(languageID, new DwLangHoverProvider(worker)));
