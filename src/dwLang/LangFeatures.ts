...
export class DwLangCompletionItemProvider implements languages.CompletionItemProvider {
    constructor(
    ...
    async provideCompletionItems(
        ...
        const info = await worker.doComplete(resource.toString(), position, wordInfo);
...
export class DiagnosticsAdapter {
    ...
    private async validate(model: editor.IModel): Promise<void> {
        try {
            ...
            const markerData: editor.IMarkerData[] = await worker.doValidation(resource.toString());
